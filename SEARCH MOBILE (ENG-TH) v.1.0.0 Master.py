...
# Then Just input Folder paths, the keyword you want to search, and the file extension
...
# เพียงแค่ป้อนตำแหน่งของโฟลเดอร์ คำที่ต้องการค้นหา และนามสกุลของไฟล์นั้น ๆ 
...
print("เพียงแค่ป้อนตำแหน่งของโฟลเดอร์ คำที่ต้องการค้นหา และนามสกุลของไฟล์นั้น ๆ ")
